...
<input type ="submit" class="tombol_kembali" name = "kembali" value = "kembali">
 ...
 <option value="">-- Pilih Jurusan -- </option>
     <option value="xipa8.php?XIPA"> IPA</option>
     <option value="xips8.php?XIIPA"> IPS</option>
 </select>
    <?php
        if (isset($_GET["XIPA"])) { header ("location:xipa8.php");}
        elseif(isset($_GET["XIIPA"])) { header ("location:xips8.php");}
    ?>
