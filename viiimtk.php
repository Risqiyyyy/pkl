...
?>
 <form action = "mtksmp.php" method ="POST" name="kembali">
<input type ="submit" class="tombol_kembali" name = "kembali" value = "kembali">
 </form>
 
 <form action = "viimtk.php" method ="POST" name="vii">
    <input type ="submit" class="tombol2" name = "vii" value = "VII">
    </form>

    <form action = "viiimtk.php" method ="POST" name="viii">
    <input type ="submit" class="tombol2" name = "viii" value = "VIII">
    </form>

    <form action = "ixmtk.php" method ="POST" name="ix">
