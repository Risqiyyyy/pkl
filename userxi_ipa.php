...
public function showData()
    ...
    public function showDataGuruXiipa()
	{
        $conn = new Koneksi();
        $db=$conn->metal();
		$stmt=$db->prepare("SELECT NIG,nama,kelas,Tingkatan,tgl_lahir,jk,alamat, nama_jurusan FROM guru where NIG= '329876' AND kelas='XI' AND nama_jurusan='IPA' ORDER BY nama ASC ");
		$stmt->execute(); 
		return $stmt;
	}
}