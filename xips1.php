...
<input type ="submit" class="tombol_kembali" name = "kembali" value = "kembali">
 ...
 <option value="">-- Pilih Jurusan -- </option>
     <option value="xipa1.php?XIPA"> IPA</option>
     <option value="xips1.php?XIIPA"> IPS</option>
 </select>
    <?php
        if (isset($_GET["XIPA"])) { header ("location:xipa1.php");}
        elseif(isset($_GET["XIIPA"])) { header ("location:xips1.php");}
    ?>
