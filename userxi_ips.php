...
public function showData()
    ...
    public function showDataGuruXiips()
	{
        $conn = new Koneksi();
        $db=$conn->metal();
		$stmt=$db->prepare("SELECT NIG,nama,kelas,Tingkatan,tgl_lahir,jk,alamat, nama_jurusan FROM guru where NIG= '	66413' AND kelas='XI' AND nama_jurusan='IPS' ORDER BY nama ASC ");
		$stmt->execute(); 
		return $stmt;
	}
}