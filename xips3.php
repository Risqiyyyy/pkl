...
?>
 <form action = "mapelsma.php" method ="POST" name="kembali">
<input type ="submit" class="tombol_kembali" name = "kembali" value = "kembali">
 ...
 <option value="">-- Pilih Jurusan -- </option>
     <option value="xipa3.php?XIPA"> IPA</option>
     <option value="xips3.php?XIIPA"> IPS</option>
 </select>
    <?php
        if (isset($_GET["XIPA"])) { header ("location:xipa3.php");}
        elseif(isset($_GET["XIIPA"])) { header ("location:xips3.php");}
    ?>
