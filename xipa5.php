...
<input type ="submit" class="tombol_kembali" name = "kembali" value = "kembali">
 ...
 <option value="">-- Pilih Jurusan -- </option>
     <option value="xipa5.php?XIPA"> IPA</option>
     <option value="xips5.php?XIIPA"> IPS</option>
 </select>
    <?php
        if (isset($_GET["XIPA"])) { header ("location:xipa5.php");}
        elseif(isset($_GET["XIIPA"])) { header ("location:xips5.php");}
    ?>
